          ...
          <Stack spacing={5}>
            <Stack spacing={4}>
              ...
              <ResearchCard
                ...
                body="Research studies have shown that frequent testing improves learning, with bigger impact than rehearsal strategies such as re-reading a
                 textbook or re-watching lectures. This study presents a quasi-experimental study to examine the effect of using frequent, automated examinations 
                 in an advanced computer science course: in the first semester students were given traditional paper-based exams, and in 
                 the following semester students took frequent computer-based tests, while other aspects of the course were held constant. It was observed 
                 a significant change in the distribution of students' grades with fewer students failing the final examination, and proportionately more students 
                  earning grades of B and C."
              ...
              <ResearchCard
                ...
                body="This study compares final exam performance from two different semesters in a mechanical engineering course,
              the first offering including two midterms and a final exam, and the other with seven bi-weekly quizzes and the same final exam. 
              ...
              <ResearchCard
                ...
                body="Second-chance testing, where students are allowed to take a second instance of an exam for some form of grade replacement, is a less expensive approximation of
                 mastery-based learning that can be easily integrated into a broad range of college course structures. This paper analyzes three different grading policies, where all of them 
                 encourage the students to prepare adequately for the first-chance exam and review the material again before the second-chance exam, if they elect to take it. By comparing 
                 these different course policies, we show that grading policies have a significant effect on whether students take second-chance exams. The data also
                 suggests that adding a second-chance exam had no effect on student performance or study habits for the first-chance exam."
                reference="G. L. Herman, K. Varghese, and C. Zilles, 'Second-chance testing course policies and student behavior', FIE 2019."
                paperHref="https://ieeexplore.ieee.org/document/9028490"
              />
              <ResearchCard
                title="Second-chance exams and impact on student learning"
                body="This quasi-experimental study in a single course compares the effect of two grading policies for second-chance exams and the effect of increasing the size of the 
                range of dates for students taking asynchronous exams. The first grading policy, called 90-cap, allowed students to optionally take a second-chance exam that would 
                fully replace their score on a first-chance exam except the second-chance exam would be capped at 90% credit. The second grading policy, called 90-10, combined 
                students' first- and second-chance exam scores as a weighted average. The 90-10 policy significantly increased the likelihood that marginally competent students 
                would take the second-chance exam. Further, our data suggests that students learned more under the 90-10 policy, providing improved student learning outcomes 
                at no cost to the instructor."
                ...
                paperHref="https://dl.acm.org/doi/10.1145/3372782.3406260"
              />
              <ResearchCard
                title="Student perceptions on second-hance exams"
                body="This study complements previous work by including interviews from a diverse group of 23 students that have taken courses that use 
                second-chance testing. From the interviews, we sought to gain insight into students’ views and use of second-chance testing. 
                We found that second-chance testing was almost universally viewed positively by the students and was frequently cited as helping to reduce 
                test takers’ anxiety and boost their confidence. Overall, we find that the majority of students prepare for second-chance exams in desirable ways,
                but we also note ways in which second-chance testing can potentially lead to undesirable behaviors including procrastination, 
                ...
                paperHref="https://ieeexplore.ieee.org/document/9637173"
              />
              <ResearchCard
              ...
              <ResearchCard
                ...
                body="This study investigates fairness when adopting exam versioning and randomization to mitigate cheating during asynchronous online exams.
                It uses a Generalized Partial Credit Model (GPCM) Item-Response Theory (IRT) model to fit exams from a for-majors data structures course and non-majors CS0 course, 
                both of which used randomly generated exams. For all exams, students' estimated ability and exam score are strongly correlated (ρ ≥ 0.7), 
                suggesting that the exams are reasonably fair. Through simulation, we find that most of the variance in any given student's simulated scores is due to chance 
                and the worst of the score impacts from possibly unfair permutations is only around 5 percentage points on an exam."
                ...
                paperHref="https://dl.acm.org/doi/10.1145/3478431.3499388"
              />
              <ResearchCard
                title="Student's strategies when completing exams with immediate feedback"
                body="When taking a computer-based exam using PrairieLearn, students have the option to receive immediate feedback on their submitted answer  
                or they can defer the feedback and grade questions in bulk. This study analyzes data from three courses across two semesters, and 
                finds that only a small minority of students used the deferred feedback option. Moreover, four main submission strategies were identified and they were correlated to statistically 
                significant differences in exam scores, however it was not clear if some strategies improved outcomes or if stronger students tended to prefer certain strategies."
                reference="A. Verma, T. Bretl, M. West, and C. Zilles, 'A quantitative analysis of when students choose to grade questions on computerized exams with multiple attempts',
                L@S 2020."
                paperHref=""
              />
              <ResearchCard
              ...
              <ResearchCard
                ...
                body="This paper introduces a simple HTML markup language added to PrairieLearn to create automated drawing-based questions, allowing students to draw diagrams, 
                graphs and design solutions on the computer that are instantly auto-graded by the computer. A key advantage of this new tool over previous work is that the
                question author does not need to write any explicit programming code. We present results from student interaction data with the system, 
                student surveys, and feedback from instructors and question authors."
            ...
            <Stack spacing={4}>
              ...
              <ResearchCard
                ...
                body="Using a data set from 29,492 asynchronous exams in CBTF, we observed correlations between when a student chooses to take their exam within the exam period and 
                their score on the exam. Somewhat surprisingly, instead of increasing throughout the exam period, which might be indicative of widespread collaborative cheating, 
                we find that exam scores decrease throughout the exam period. While this could be attributed to weaker students putting off exams, this effect holds even when 
                accounting for student ability as measured by a synchronous exam taken during the same semester."
                ...
                paperHref="https://dl.acm.org/doi/10.1145/3051457.3051465"
              />
              <ResearchCard
                title="Understanding the performance trends during asynchronous exams"
                body="This study presents a hypothesis that the average exam scores decline over the exam period in asynchronous testing is primarily due 
                to self-selection effects, where weaker students tend to choose exam times later in the exam period, while stronger students are more likely to choose earlier times. 
                We used data from 31,673 exams over four semesters from six undergraduate engineering and computing courses that had both 
                synchronous and asynchronous exams. We analyzed student exam time choice and asynchronous exam scores, using synchronous exam scores in the same course as a control variable.
                We conclude that self-selection effects are primarily responsible for exam score declines over time, 
                that exam time selection is unlikely to be a useful target for interventions to improve performance, and that there is 
                no evidence for widespread collaborative cheating in the dataset used in this research."
                ...
                paperHref="https://eric.ed.gov/?id=EJ1254087"
              />
              <ResearchCard
                title="How much randomization is needed to reduce cheating?"
                body="This paper investigates randomization on asynchronous exams as a defense against collaborative cheating.
                Collaborative cheating occurs when one student (the information producer) takes the exam early and passes information about the exam to other students (the information consumers) 
                that are taking the exam later. Using a dataset from 425 students, we identified 5.5% of students 
                (on average) as information consumers. These information consumers had a significant advantage (13% on average) when every student was given the same exam problem 
                but that advantage dropped to almost negligible levels (2-3%) when students were given a random problem from a pool of two or four problems."
                ...
                paperHref="https://dl.acm.org/doi/10.1145/3231644.3231664"
              />
              <ResearchCard
                title="Measuring score advantage during unproctored exams"
                body="This study investigates the score advantage of unproctored exams versus proctored exams using a within-subjects design for 510 students in 
                a CS1 course with 5 proctored exams and 4 unproctored exams. We found that students scored 3.3 percentage points higher on questions on unproctored exams 
                than on proctored exams. More interestingly, however, we discovered that this score advantage on unproctored exams grew steadily as the semester progressed, 
                from around 0 percentage points at the start of semester to around 7 percentage points by the end, indicating that students were 'learning to cheat'. 
                The data suggests that both more individuals are cheating and the average benefit of cheating is increasing over the course of the semester."
                ...
                paperHref="https://dl.acm.org/doi/10.1145/3386527.3405925"
              />
              <ResearchCard
            ...
            <Stack spacing={4}>
              ...
              <ResearchCard
                ...
                body="Two major concerns reported by students taking computer-based testing are: (1) limited access to the assessment after completion, and (2) the lack of partial credit. 
                To address these concerns, the CBTF adopted a new exam-review service to provide in-person feedback to students after the completion of computerized exams. 
                These review sessions are conducted by course staff and hosted at the CBTF to ensure the integrity of exam problems for future use. 
                In this paper, we present the design of this review system, including the scheduling logistics, software support, course staff training, and guidance to students. 
                ...
                reference="W. L. Chang, M. West, C. Zilles, D. Mussulman, and C. Sacris, 'Computerized exam reviews: In-person and individualized feedback to
                 students after a computerized exam', ASEE 2020."
                paperHref="https://peer.asee.org/computerized-exam-reviews-in-person-and-individualized-feedback-to-students-after-a-computerized-exam"
              />
            </Stack>
            ...
            <Stack spacing={4}>
              ...
              <ResearchCard
                ...
                body="This paper explores the times students choose to take an asynchronous exam at CBTF, when students make and change their reservations, and the correlation 
                between when students choose to take exams and their exam performance. Among our results, we find that students prefer to take exams in late afternoon/early 
                evening towards the end of the exam period. In addition, we find that students frequently re-schedule when they take exams. 
                Finally, we find that there is a correlation between how early in the exam period a student takes an exam and their score on the exam."
            ...
            <Stack spacing={4}>
              ...
              <ResearchCard
                ...
                body="In this paper, we describe a 7-point rubric developed for scoring student responses to 'Explain in plain English' questions, reporting four different ways to validate the rubric."
                ...
                paperHref="https://dl.acm.org/doi/abs/10.1145/3328778.3366879"
              />
              <ResearchCard
                title="Auto-grading 'Explain in plain English' questions"
                body="Previous research suggests that 'Explain in Plain English' (EiPE) code reading activities could play an important role in the development of novice programmers,
                but EiPE questions aren’t heavily used in introductory programming courses because they (traditionally) required manual grading. We present what we believe to be the first 
                automatic grader for EiPE questions and its deployment in a large-enrollment introductory programming course. Based on a set of questions deployed on a computer-based exam, 
                we find that our implementation has an accuracy of 87–89%, which is similar in performance to course teaching assistants trained to perform this task and compares 
                favorably to automatic short answer grading algorithms developed for other domains."
                ...
                paperHref="https://dl.acm.org/doi/abs/10.1145/3408877.3432539"
              />
              <ResearchCard
                title="Peer-grading 'Explain in plain English' questions"
                body="This paper presents the use of peer grading for 'Explain in Plain English' (EipE) questions in a large enrollment introductory programming course, where students were 
                asked to categorize other students’ responses. We developed a novel Bayesian algorithm for performing calibrated peer grading on categorical data, and we used a heuristic grade 
                assignment method based on the Bayesian estimates. The peer-grading exercises served both as a way to coach students on what is expected from EipE questions and as a way to 
                alleviate the grading load for the course staff."
