        ...
        <div className="container-md">
          <Stack spacing={5}>
            <Stack spacing={4}>
              ...
              <ResearchCard
                title="Comparing second-chance testing policies"
                referenceHref="https://peer.asee.org/43019"
                reference="C. Emeka, D. Smith, C. Zilles, M. West, G. L. Herman, and T. Bretl, 'Determining the Best Policies for Second-Chance Tests for STEM Students', ASEE 2023."
              ></ResearchCard>

              <ResearchCard
                title="Second-chance testing to reduce test anxiety"
                referenceHref="https://peer.asee.org/44207"
                reference="C. Emeka, C. Zilles, M. West, G. L. Herman, and T. Bretl, 'Second-Chance Testing as a Means of Reducing Students’ Test Anxiety and Improving Outcomes', ASEE 2023."
              ></ResearchCard>
            </Stack>
            ...
            <Stack spacing={4}>
              ...
              <ResearchCard
                title="Effect of AI grading mistakes on learning"
                reference="T. Li, S. Hsu, M. Fowler, Z. Zhang, C. Zilles, and K. Karahalios, 'Am I Wrong, or Is the Autograder Wrong? Effects of AI Grading Mistakes on Learnings',  ICER 2023."
                referenceHref="https://doi.org/10.1145/3568813.3600124"
              >
                This papers presents survey and interview results that recorded
                students’ interactions with a short-answer AI autograder for
                “Explain in Plain English” code reading problems. Using causal
                modeling, they inferred the learning impacts of wrong answers
                marked as right (false positives, FPs) and right answers marked
                as wrong (false negatives, FNs).
              </ResearchCard>
            </Stack>

            <Stack spacing={4}>
              <Heading>Open Educational Resources (OER)</Heading>
              <ResearchCard
                title="Incentives for, needs of, and motivations surrounding OER"
                reference="M. Fowler, D. Smith, B. Chen, and C. Zilles, '“I Don’t Gamble To Make My Livelihood”: Understanding the Incentives For, Needs Of, and Motivations Surrounding Open Educational Resources in Computing', ICER 2023."
                referenceHref="https://dl.acm.org/doi/10.1145/3568813.3600136"
              >
                This paper aims to understand what motivates and dissuades
                instructors to contribute to and adopt OERs. In addition, they
                investigate what would increase the likelihood of instructors
                contributing their work to OER repositories.
              </ResearchCard>
            </Stack>

            <Stack spacing={4}>
              <Heading>CS1 Research Studies</Heading>
              <ResearchCard
                title="Explaining, tracing and writing skills"
                reference="M. Fowler, D. Smith, M. Hassan, S. Poulsen, M. West, and C. Zilles, 'Reevaluating the relationship between explaining, tracing, and writing skills in CS1 in a replication study', Computer Science Education 2022"
                referenceHref="https://doi.org/10.1080/08993408.2022.2079866"
              >
                This study aims to replicate a slightly simplified hierarchy of
                skills in CS1 using a larger body of students in a non-major
                introductory Python course with computer-based exams. We also
                explore the validity of other possible hierarchies.
              </ResearchCard>
            </Stack>
