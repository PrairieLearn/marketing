...
If you are a Student, you agree that we may (i) make your User Content available to your Teacher(s) and School(s), and (ii) for the purposes of improving the Service only and at all times on a confidential basis, use your Educational Records solely on an aggregated, de-identified basis and will not share such information with third parties.
