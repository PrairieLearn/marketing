...
**De-identified information:** We may use the information we obtain via the Services (as described above) to create de-identified data, which is a collection of information where the User cannot be identified as an individual. We may generate and use de-identified data, including aggregated de-identified information, to operate, secure, and improve the Service and understand service usage, subject to our [Terms of Service](/legal/terms) and applicable institutional agreements and instructions.
...
- Deliver, support, secure, and improve the Sites and our products and services, including through auditing and data analysis to monitor performance and reliability, diagnose and resolve technical problems, and investigate security incidents;
- Carry out transactions you have requested;
- Enforce our [Terms of Service](/legal/terms), our Privacy Policy, and other agreements with you, and verify compliance with our contractual obligations;
...
- PrairieLearn does not and will not use your Personal Information or User Content to train machine learning or artificial intelligence models. While PrairieLearn may use generative AI features to enhance the Service, your data remains yours and is never used as training data for AI models.
