  ...
  return (
    <React.Fragment>
      ...
      <div className={classnames("container-fluid py-4 my-5")}>
        <div className="container-md">
          <div className="row">
            ...
            <div className="col-md-6">
                <h2 className={classnames("pb-3", styles.heading)}>Assessments</h2>
                <p>
                  Assessments are collections of questions that are graded together. Use
                  them to create homework, exam, quiz, pre-lecture, group work,
                  or any other assignment you have in your course.
                </p>
                <p>
      ...
      <div className={classnames("container-fluid py-4", ContainerStyle.grayContainer)}>
        <div className="container-md">
          <div className="mb-3">
            <h2 className={classnames("pb-3", styles.heading)}>Assessment Galery</h2>
            <Stack spacing={3}>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
                ...
                <p>
                  ...
                  questions can be completely static, the key feature of PrairieLearn questions
                  is the ability to generate, display, and grade many unique variants of
      ...
      <div className={classnames("container-fluid py-4", ContainerStyle.grayContainer)}>
        <div className="container-md">
          <div className="my-3">
          <h2 className={classnames("pb-3", styles.heading)}>Question Galery</h2>
          <p>
          ...
          <p>
            Once you're familiar with the basics, check out this question gallery
            with example questions that take full advantage of the
