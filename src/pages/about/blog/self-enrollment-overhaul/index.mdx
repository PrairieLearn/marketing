...
The new self-enrollment and publishing system is finally here! These systems should solve a variety of pain-points
with the previous way of managing access to course instances, and we are excited for instructors to try it out.
This post details the new features, as well as lists some common FAQ for instructors familiar with the old system.
...
There are now additional security features for managing enrollment in your course instance.
