...
The new self-enrollment and publishing systems are here! They bring many improvements including the ability to manage everything in the UI (no need to edit JSON), and
fine-grained self-enrollment controls.
...
2. Going forward, how students can access your course instance is changing.
   ...
   There is no longer an enrollment page for students to find courses.
...
Self-enrollment allows students to enroll in a course instance as long as they have a code or link to join the course.
...
You can also explicitly invite students to your course. These invitations will show up on the homepage for students to accept an invitation.
If you want full control over everyone in your course, consider disabling self-enrollment completely.

You can invite a student to your course instance by clicking the "Invite" button on the "Students" tab.
...
Students are able to enroll in published course instances and access its contents.
...
You can grant an extension to give specific students access to the course instance beyond the original date. If a student has multiple extensions, the latest one takes effect.
