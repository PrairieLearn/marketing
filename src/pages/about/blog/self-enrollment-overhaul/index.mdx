...
The new self-enrollment and publishing systems are here! They bring many improvements, including the ability to manage everything in the UI (no need to edit JSON) and fine-grained self-enrollment controls.
...
You can also explicitly invite students to your course. These invitations will show up on the homepage for students to accept.
