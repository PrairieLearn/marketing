...
Of course, once you're happy with the content to-be-imported, you're able to work with and manipulate your new questions and assessments as you'd expect within the application to make the most of features PrairieLearn has which Canvas doesn't, including our all-new [AI grading feature](/about/blog/introducing-ai-grading).
...
The import process includes only the binary assets (think images, figures, PDFs) which are referenced by your questions and assessments, and leave out the bits that aren't relevant to PrairieLearn, like wiki content and other unreferenced files. Because we only capture the content and media that will be used within PrairieLearn's robust assessment ecosystem, you can start with an exported archive of any size, and the application will automatically trim away unneeded files.
