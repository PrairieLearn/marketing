...
The import process includes only the binary assets (think images, figures, PDFs) which are referenced by your questions and assessments, and leave out the bits that aren't relevant to PrairieLearn, like wiki content and other unreferenced files. Because we only capture the content and media that will be used within PrairieLearn's assessment ecosystem, you can start with an exported archive of any size, and the application will automatically trim away unneeded files.
