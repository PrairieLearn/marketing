...
<div className="my-4">
  <div className="lh-sm mb-1">
    **Numerical methods question:** 100 typed paragraph submissions
  </div>
...
<div className="my-4">
  <div className="lh-sm mb-1">
    **Intro dynamics question:** 100 handwritten submissions
  </div>
  <div className="table-responsive">
    <table className="table">
      <thead>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td className="text-end">2m 30s</td>
        </tr>
      </tbody>
    </table>
  </div>
...
<BlogCalloutBox variant="info">
  More detailed information can be found in the <a href="https://docs.prairielearn.com/aiGrading/" target="_blank" rel="noopener noreferrer">AI grading documentation</a>. If you have questions, let us know on <a href="/slack" target="_blank" rel="noopener noreferrer">Slack</a>.
</BlogCalloutBox>
